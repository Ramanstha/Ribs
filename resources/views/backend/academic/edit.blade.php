            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endif
                        <form action="{{route('update.academic',$data->id)}}" method="post"
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <select name="category_id" class="form-control" id="category">
                                    ...
                                    <option value="{{$category->id}}"
                                        {{ $data->category_id==$category->id?'selected':'' }}>{{$category->title}}
                                    </option>
                                    @endforeach
                                </select>
                                @error('category_id')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="subcategory_id" class="form-control" id="subcategory">
                                    ...
                                    <option value="{{$category->id}}"
                                        {{ $data->subcategory_id==$category->id?'selected':'' }}>{{$category->title}}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{asset('storage/academic/'.$data->image)}}" height="100" width="100">
                            </div>

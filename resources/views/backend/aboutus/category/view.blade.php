    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <a href="{{route('create.aboutcategory')}}" class="btn btn-danger mb-2"><i class="fa fa-plus-circle me-2"></i>
                            Add Category</a>
                    </div>
                </div>
                    ...
                    <table id="example" class="table table-centered table-striped dt-responsive nowrap w-100"
                        ...
                        <tbody id="tablecontents">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input data-id="{{$category->id}}" class="aboutcategory" type="checkbox"
                                        data-onstyle="success" data-offstyle="danger" data-toggle="toggle"
                                        data-on="Active" data-off="InActive" {{ $category->status ? 'checked' : '' }}>
                                </td>
                                <td>
                                    <a href="{{ route('edit.aboutcategory',$category->id) }}" title="Edit"><i
                                            class="fa fa-edit "></i></a>
                                    <a href="{{ route('delete.aboutcategory',$category->id) }}"

    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <a href="{{route('create.message')}}" class="btn btn-danger mb-2">
                            <i class="fa fa-plus-circle me-2"></i> Message</a>
                    </div>
                </div>
                    ...
                    <table id="example" class="table table-centered table-striped dt-responsive nowrap w-100"
                        ...
                        <tbody id="tablecontents">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit.message',$site->id)}}" title="Edit"><i class="fa fa-edit "></i></a>
                                    <a href="{{route('delete.message',$site->id)}}" onclick="return confirm('Are you sure you want to delete?')" id="sa-params"

			...
			<div class="row ">
				<div class="tz-gallery d-flex flex-wrap justify-content-between">
					...
					<div class="cat-item col-sm-12 col-md-3 col-lg-3 py-3 overflow-hidden">
						<a class="" href="{{asset('storage/galleryfeestructure/main/'.$gallery->image)}}"
							target="_blank">
...
<img class="" src="{{asset('storage/galleryfeestructure/thumbnail/'.$gallery->image)}}" alt="Gallery Images"
	width="100%">
</a>
</div>
@endforeach
